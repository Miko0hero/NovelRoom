...
public class CacheConstants {
    ...
    public enum CacheEnum {
        ...
        BOOK_NEWEST_RANK_CACHE(2, BOOK_NEWEST_RANK_CACHE_NAME, 60 * 30, 1),

        BOOK_UPDATE_RANK_CACHE(2, BOOK_UPDATE_RANK_CACHE_NAME, 60, 1),
        ...
        AUTHOR_INFO_CACHE(1, AUTHOR_INFO_CACHE_NAME, 60 * 60 * 48, 1000);
